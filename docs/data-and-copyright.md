...
The table relationships and currently materialised columns are shown in the diagram below (source: [`assets/images/database.dot`](../assets/images/database.dot), rendered image: [`assets/images/database.svg`](../assets/images/database.svg)):
...
| `methods.notationSiril` | Siril-friendly notation derived from `notationExpanded` and `stage`, used when serialising method data for clients that consume Siril notation directly. |
