define( ['../helpers/_', '../plugins/google!maps/3/sensor=false'], function( _, googleAjaxReady ) {
	if( typeof window['towerMaps'] === 'undefined' ) {
		window['towerMaps'] = [];
	}
	// Attach events
	// Resize
