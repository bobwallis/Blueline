( function( window, document ) {
	var SVG = false, Canvas = false, Paper;
	
	// A lightweight SVG wrapper
	if( window.can.SVG() ) {
	...
	// A lightweight canvas wrapper
	if( window.can.canvas() ) {
	...
	Paper = function( options ) {
		...
		else if( window.VML !== false ) {
			return new window.VML( options );
		}
		return false;
	};
	window['Paper'] = Paper;
