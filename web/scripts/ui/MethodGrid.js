...
define( ['jquery', 'plugins/webfont!BluelineMono', '../helpers/PlaceNotation', '../helpers/Paper', '../helpers/DroidSansMono'], function( $, customFontLoaded, PlaceNotation, Paper, Font ) {
	// Constants
