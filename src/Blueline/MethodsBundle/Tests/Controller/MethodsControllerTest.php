...
class MethodsControllerTest extends WebTestCase
{
    public function testMethods()
    {
        ...
        foreach (array('/methods/view/Cambridge_Surprise_Minor.png', '/methods/view/Cambridge_Surprise_Minor.png?scale=2', '/methods/view/Cambridge_Surprise_Minor.png?style=line', '/methods/view/Cambridge_Surprise_Minor.png?scale=2&style=grid') as $page) {
            $client = static::createClient();
            $crawler = $client->request('GET', $page);
            $this->assertTrue($client->getResponse()->isSuccessful(), $page.' request unsuccessful');
