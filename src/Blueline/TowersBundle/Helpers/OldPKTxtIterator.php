...
class OldPKTxtIterator implements \Iterator, \Countable
{
    ...
    public function __construct($file)
    {
        ...
        if ( ( $columns = fgetcsv( $handle, 25, "\\" ) ) === false ) { return false; }
    ...
    public function rewind() { return reset( $this->oldPKArray ); }
    public function current() { return current( $this->oldPKArray ); }
