...
class LongCounty
{
    ...
    private static $australianAreas = [
        'SA' => 'South Australia',
        'NSW' => 'New South Wales',
        'Vict' => 'Victoria',
        'Vic' => 'Victoria',
    ...
    private static $newZealandAreas = [
        'NI' => 'North Island',
        'SI' => 'South Island',
    ];

    private static $southAfricanAreas = [
        'WC' => 'Western Cape',
        'KZN' => 'KwaZulu-Natal',
        'EC' => 'Eastern Cape',
        'Gaut' => 'Gauteng',
    ...
    private static $netherlandsAreas = [
