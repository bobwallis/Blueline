...
<collection
	...
	date="<?= date( 'Y-m-d' )?>">
	<collectionName>Search results for: <?=$this->encode( 'queryString' )?></collectionName>
	...
	<opensearch:totalResults><?=$this->get( 'count' )?></opensearch:totalResults>
	<opensearch:startIndex><?=$this->get( 'limit[current]' )?></opensearch:startIndex>
	<methodSet>
