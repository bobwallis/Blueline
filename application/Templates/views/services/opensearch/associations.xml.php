	...
	<Url rel="suggestions" type="application/x-suggestions+json" indexOffset="0" template="<?php echo $site['baseURL']; ?>/services/opensearch/suggestions/associations?q={searchTerms}&amp;count={count}&amp;from={startIndex}" />
