...
?>
	...
	<Url rel="suggestions" type="application/x-suggestions+json" indexOffset="0" template="<?php echo $baseURL; ?>/services/suggestions/associations?q={searchTerms}&amp;count={count}&amp;from={startIndex}" />
