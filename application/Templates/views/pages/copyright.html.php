...
<section class="wallOfText hyphenate">
	<p>Most method data (names, place notation, lead head, symmetry, FCH groups, hunt bells, lead length and first peal details) are derived from the <a href="http://www.cccbr.org.uk/" class="external">Central Council of Church Bellringers</a> data available on <a href="http://www.methods.org.uk" class="external">methods.org.uk</a>. The copyright statment below applied to its use. The details of common calls for methods are not included in the Central Council data.</p>
